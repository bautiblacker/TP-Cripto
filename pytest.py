...
a = 84
b = 13
aux1 = F.Add(57,F.Multiply(57,22))
aux2 = F.Add(aux1,F.Multiply(F.Multiply(57,22),22))
aux3 = F.Add(aux2,F.Multiply(F.Multiply(F.Multiply(57,22),22),22))
